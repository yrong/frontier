...
pub struct EthApi<B: BlockT, C, P, BE, H: ExHashT, A: ChainApi> {
	pool: Arc<P>,
	graph: Arc<Pool<A>>,
	client: Arc<C>,
...
impl<B: BlockT, C, P, BE, H: ExHashT, A: ChainApi> EthApi<B, C, P, BE, H, A> {
	pub fn new(
		client: Arc<C>,
		pool: Arc<P>,
		graph: Arc<Pool<A>>,
...
impl<B, C, P, BE, H: ExHashT, A> EthApiT for EthApi<B, C, P, BE, H, A>
where
